...
extern volatile sint16 ECPULSEL[10];          //速度全局变量
extern volatile sint16 ECPULSER[10];
extern int ECPULSE_L;
extern int ECPULSE_R;
...
extern volatile float Target_Speed1;          // 速度全局变量
extern volatile float Target_Speed2;          // 速度全局变量

extern volatile float Real_Speed1;          // 速度全局变量
extern volatile float Real_Speed2;          // 速度全局变量

extern volatile double start_V_L;
extern volatile double start_V_R;

extern volatile sint16 Target_Duty1;// 目标占空比变量
extern volatile sint16 Target_Duty2;

extern volatile sint16 Real_Duty1;// 实际占空比变量
extern volatile sint16 Real_Duty2;

extern float K_Pid_L;

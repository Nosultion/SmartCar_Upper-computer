...
//	TFTSPI_Write_Byte(0x00);	    //0x08		//VPA =8，约90Hz
    ...
    TFTSPI_Write_Byte(0x01);     //0x08     //DIVA=8
    TFTSPI_Write_Byte(0x2C);        //0x08      //VPA =8，约90Hz
    TFTSPI_Write_Byte(0x2D);     //0x08     //DIVA=8
...
/*!
  * @brief  TFTSPI_P8X16Str  液晶字符串输出(8*8字体)
  *
  * @param    x:0 - 15 (行)
  * @param    y:0 - 19 (列)
  * @param    word_color: 字体颜色
...
//     }
    ...
    for ( int i = 0; i < high; i ++)          //神眼高 120
    {
        for ( int j = 14; j < wide+14; j ++)     //神眼宽188
        {
            /* 将灰度转化为 RGB565 */

...
sint16 ServoDuty = 0;
sint16 MotorDuty1 = 0;      // 电机驱动占空比数值
sint16 MotorDuty2 = 0;      // 电机驱动占空比数值
...
void EncInit (void)
{
    ENC_InitConfig(ENC2_InPut_P33_7, ENC2_Dir_P33_6);//编码器1
    ENC_InitConfig(ENC4_InPut_P02_8, ENC4_Dir_P33_5);//编码器2
    ENC_InitConfig(ENC5_InPut_P10_3, ENC5_Dir_P10_1);//编码器3
    ENC_InitConfig(ENC6_InPut_P20_3, ENC6_Dir_P20_0);//编码器4
}
